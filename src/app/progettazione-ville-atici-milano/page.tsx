...
export const metadata = { 
  title: 'Progettazione Ville e Attici Milano',
  description: 'Progettazione ville e attici a Milano. BlueDesign dal 1990.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Progettazione Ville e Attici',
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Ville e Attici a <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Immobili di <span className="text-white font-medium">prestigio</span>. Il meglio del design.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c9a962]/10 rounded-full mb-6">
              ...
              <span className="text-[#c9a962] text-sm font-medium">Immobili di Prestigio</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-4">I tuoi problemi, la nostra soluzione</h2>
            <p className="text-white/50 max-w-2xl mx-auto">Progettiamo ville e attici che valorizzano il tuo immobile di prestigio.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: HomeIcon, title: "Ville plurifamiliari", desc: "Progettazione di case di charme.", highlight: "Design esclusivo" },
              { icon: StarIcon, title: "Attici rooftops", desc: "Terrazzi e solarium di design.", highlight: "Vista panoramica" },
              { icon: SparklesIcon, title: "Design esclusivo", desc: "Materiali e finiture premium.", highlight: "Premium finish" },
              { icon: HomeIcon, title: "Spazi ampi", desc: "Gestione di superfici importanti.", highlight: "Ottimizzazione spazi" }
            ].map((item, index) => (
      ...
      <section className="py-24 bg-[#12121a]">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { icon: MapPinIcon, title: "Zone Servite", desc: "Milano centro" },
              { icon: ClockIcon, title: "Tempi", desc: "2-6 mesi" },
              { icon: BanknotesIcon, title: "Prezzi", desc: "Da 20.000€" },
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            Progetta il tuo immobile di prestigio con i migliori professionisti. Ti offriamo un sopralluogo e un preventivo <span className="text-[#c9a962] font-semibold">gratuito e senza impegno</span>.
          </p>
