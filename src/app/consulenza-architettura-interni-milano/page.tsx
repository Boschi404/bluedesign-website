...
export const metadata = { 
  title: 'Consulenza Architettura Interni Milano',
  description: 'Consulenza architettura d\'interni a Milano. BlueDesign dal 1990.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Consulenza Architettura Interni',
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Consulenza architettura interni Milano" 
            fill 
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Consulenza a <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Architettura <span className="text-white font-medium">interni</span> professionale.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c9a962]/10 rounded-full mb-6">
              ...
              <span className="text-[#c9a962] text-sm font-medium">Consulenza Professionale</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-4">I tuoi problemi, la nostra soluzione</h2>
            <p className="text-white/50 max-w-2xl mx-auto">Consulenza professionale per trasformare i tuoi spazi.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: HomeIcon, title: "Progettazione", desc: "Studiamo la soluzione perfetta per te.", highlight: "Soluzioni personalizzate" },
              { icon: StarIcon, title: "Consulenza stilistica", desc: "Consigli su colori, materiali e arredo.", highlight: "Style advisor" },
              { icon: SparklesIcon, title: "Direzione lavori", desc: "Supervisioniamo i tuoi artigiani.", highlight: "Qualità garantita" },
              { icon: HomeIcon, title: "Acquisti assistiti", desc: "Ti accompagniamo dai fornitori.", highlight: "Supporto completo" }
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { icon: ClockIcon, title: "Tempi", desc: "Su appuntamento" },
              { icon: BanknotesIcon, title: "Prezzi", desc: "Da 150€" },
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            Architettura d'interni con i migliori professionisti di Milano. Ti offriamo un sopralluogo e un preventivo <span className="text-[#c9a962] font-semibold">gratuito e senza impegno</span>.
          </p>
