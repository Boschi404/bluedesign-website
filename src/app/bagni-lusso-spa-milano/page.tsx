...
export const metadata = { 
  title: 'Bagni di Lusso e Spa Milano',
  description: 'Bagni di lusso e spa a Milano. BlueDesign dal 1990.'
};
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Bagni di Lusso a <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Spa <span className="text-white font-medium">wellness</span> a casa tua. Il bagno come esperienza.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c9a962]/10 rounded-full mb-6">
              ...
              <span className="text-[#c9a962] text-sm font-medium">Wellness a Casa</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-4">I tuoi problemi, la nostra soluzione</h2>
            <p className="text-white/50 max-w-2xl mx-auto">Progettiamo bagni spa che trasformano il tuo bagno in un'esperienza di benessere.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: HomeIcon, title: "Bagni wellness", desc: "Sauna, hammam, doccia emozionale: relax totale.", highlight: "Relax totale" },
              { icon: StarIcon, title: "Materiali pregiati", desc: "Marmo, pietra naturale, vetro temperato.", highlight: "Lusso materials" },
              { icon: SparklesIcon, title: "Illuminazione d'atmosfera", desc: "LED cromatici, specchi con luce integrata.", highlight: "Ambiente perfetto" },
              { icon: HomeIcon, title: "Arredo spa", desc: "Vasche idromassaggio, colonne doccia.", highlight: "Comfort assoluto" }
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { icon: ClockIcon, title: "Tempi", desc: "4-8 settimane" },
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            Progetta il tuo bagno spa con i migliori professionisti di Milano. Ti offriamo un sopralluogo e un preventivo <span className="text-[#c9a962] font-semibold">gratuito e senza impegno</span>.
          </p>
