...
export const metadata = { 
  title: 'Progettazione Interni Render 3D Milano',
  description: 'Progettazione interni con render 3D a Milano. BlueDesign dal 1990.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Progettazione Interni Render 3D',
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Progettazione render 3D Milano" 
            fill 
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Progettazione 3D a <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Visualizza il <span className="text-white font-medium">risultato</span> prima di iniziare. Render fotorealistici.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c9a962]/10 rounded-full mb-6">
              ...
              <span className="text-[#c9a962] text-sm font-medium">Visualizzazione Realistica</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-4">I tuoi problemi, la nostra soluzione</h2>
            <p className="text-white/50 max-w-2xl mx-auto">Visualizza il tuo progetto prima di iniziare i lavori con i nostri rendering fotorealistici.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: StarIcon, title: "Visualizza prima", desc: "Vedi il risultato finale prima dei lavori.", highlight: "Anteprima reale" },
              { icon: HomeIcon, title: "Scegli consapevole", desc: "Confronta materiali e colori in 3D.", highlight: "Confronto facilitato" },
              { icon: SparklesIcon, title: "Modifiche facili", desc: "Cambia tutto prima di costruire.", highlight: "Flessibilità totale" },
              { icon: HomeIcon, title: "Rendering realistici", desc: "Foto del tuo ambiente finito.", highlight: "Fotorealismo" }
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { icon: ClockIcon, title: "Tempi", desc: "3-7 giorni" },
              { icon: BanknotesIcon, title: "Prezzi", desc: "Da 300€" },
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            Visualizza il tuo progetto in 3D con i migliori professionisti. Ti offriamo un sopralluogo e un preventivo <span className="text-[#c9a962] font-semibold">gratuito e senza impegno</span>.
          </p>
