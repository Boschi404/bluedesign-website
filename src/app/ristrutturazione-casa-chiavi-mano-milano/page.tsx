...
export const metadata = { 
  title: 'Ristrutturazione Casa Chiavi in Mano Milano | Senza Pensieri',
  description: 'Ristrutturazione casa chiavi in mano a Milano. BlueDesign dal 1990.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Ristrutturazione Casa Chiavi in Mano',
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Chiavi in Mano <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Ristrutturazione <span className="text-white font-medium">senza pensieri</span>. Un solo interlocutore.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c9a962]/10 rounded-full mb-6">
              ...
              <span className="text-[#c9a962] text-sm font-medium">Servizio Completo</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-4">I tuoi problemi, la nostra soluzione</h2>
            <p className="text-white/50 max-w-2xl mx-auto">Gestiamo tutto noi. Tu pensi solo a goderti il tuo nuovo spazio.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: HomeIcon, title: "Non hai tempo di seguire il cantiere", desc: "Lavori, hai famiglia. Non puoi passare le giornate a supervisionare. Ci pensiamo noi.", highlight: "Zero stress" },
              { icon: StarIcon, title: "Non conosci imprese fidate", desc: "Non sai chi chiamare. Noi abbiamo un team consolidato di professionisti.", highlight: "Team verificato" },
              { icon: SparklesIcon, title: "Non sai da dove iniziare", desc: "Pratiche, preventivi, scelta materiali: è tutto complicato. Ti guidiamo passo dopo passo.", highlight: "Guida completa" },
              { icon: HomeIcon, title: "Hai paura dei costi nascosti", desc: "Preventivi poco chiari, sorprese. Noi diamo prezzi fissi e trasparenti.", highlight: "Prezzi trasparenti" }
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { icon: ClockIcon, title: "Tempi", desc: "2-6 mesi" },
              { icon: BanknotesIcon, title: "Prezzi", desc: "Da 300€/mq" },
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            Ristrutturazione senza pensieri con i migliori professionisti. Ti offriamo un sopralluogo e un preventivo <span className="text-[#c9a962] font-semibold">gratuito e senza impegno</span>.
          </p>
