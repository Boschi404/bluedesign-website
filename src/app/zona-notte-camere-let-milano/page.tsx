...
export const metadata = { 
  title: 'Zona Notte e Camere da Letto Milano',
  description: 'Zona notte e camere da letto su misura a Milano.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Zona Notte e Camere da Letto',
    ...
    <main className="min-h-screen bg-[#0a0a0f]">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/images/products/bagno.jpg" alt="Zona notte Milano" fill className="object-cover" priority />
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">Zona Notte a <span className="font-semibold text-[#c9a962]">Milano</span></h1>
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">Camere da letto e <span className="text-white font-medium">armadi su misura</span></p>
      ...
      <section className="py-24 bg-[#0a0a0f]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-white/50 max-w-2xl mx-auto">Progettiamo zone notte che trasformano radicalmente il tuo spazio. Ogni progetto è unico, come unico sei tu.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: HomeIcon, title: "Hai una camera troppo piccola?", desc: "Lo spazio è limitato e non sai come sfruttarlo al meglio? Progettiamo soluzioni su misura che ottimizzano ogni centimetro, creando ambienti funzionali e spaziosi.", highlight: "Ottimizzazione spazio" },
              { icon: StarIcon, title: "Vuoi un armadio su misura?", desc: "Manca spazio per i vestiti e gli oggetti personali? Realizziamo armadi a parete, scorrevoli e guardaroba su misura che massimizzano la capacità di stivaggio.", highlight: "Massima capienza" },
              { icon: SparklesIcon, title: "Hai bisogno di più spazio?", desc: "La camera appare disordinata e manca organizzazione? Progettiamo soluzioni di storage intelligenti che tengono tutto in ordine.", highlight: "Organizzazione smart" },
              { icon: HomeIcon, title: "Vuoi rinnovare la camera?", desc: "Desideri trasformare completamente l'aspetto della tua camera da letto? Realizziamo progetti di restyling completi che donano nuova vita allo spazio.", highlight: "Restyling completo" }
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { icon: BanknotesIcon, title: "Investimento", desc: "Da 8.000€ a 40.000€" },
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h2 className="text-3xl sm:text-4xl font-light text-white mb-6">Hai bisogno di progettare la camera?</h2>
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            ...
            Scopriamo insieme la camera dei tuoi sogni.
          </p>
