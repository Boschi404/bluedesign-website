...
export const metadata = { 
  title: 'Ristrutturazione Cucine Complete Milano',
  description: 'Ristrutturazione cucine complete a Milano.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Ristrutturazione Cucine Complete',
    ...
    <main className="min-h-screen bg-[#0a0a0f]">
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Ristrutturazione Cucine a <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            {/* Subtitle */}
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Servizio <span className="text-white font-medium">chiavi in mano</span>. Dal progetto alla consegna.
            </p>
      ...
      <section className="py-24 bg-[#0a0a0f]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-white/50 max-w-2xl mx-auto">Realizziamo cucine complete che trasformano radicalmente il tuo modo di vivere la casa. Ogni progetto è unico, come unico sei tu.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { 
                icon: SparklesIcon, 
                title: "Hai una cucina datata da modernizzare?", 
                desc: "Le ante in formica ingiallite e il top in laminato rovinano l'aspetto della tua casa? Realizziamo cucine moderne con finiture di alta qualità, trasformando completamente il cuore della tua abitazione.",
                highlight: "Design all'avanguardia"
              },
              { 
                icon: HomeIcon, 
                title: "Vuoi rifare l'impianto elettrico e idraulico?", 
                desc: "L'impianto non è a norma e le tubazioni richiedono interventi complessi? Ci occupiamo di tutto: dalla progettazione alla realizzazione, gestendo pratiche, acquisto materiali e installazione.",
                highlight: "Chiavi in mano"
              },
              { 
                icon: StarIcon, 
                title: "Hai una cucina troppo piccola o mal distribuita?", 
                desc: "Lo spazio disponibile non viene sfruttato al meglio e la disposizione risulta scomoda? Progettiamo soluzioni su misura che ottimizzano ogni centimetro, creando ambienti funzionali.",
                highlight: "Ottimizzazione spazio"
              },
              { 
                icon: HomeIcon, 
                title: "Vuoi cambiare la destinazione d'uso?", 
                desc: "Desideri trasformare il tinello in cucina abitabile o adeguare la distribuzione ai tuoi bisogni? Studiamo soluzioni personalizzate per reinventare completamente lo spazio.",
                highlight: "Progettazione personalizzata"
              }
            ].map((item, index) => (
      ...
      <section className="py-20 bg-[#12121a]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-white/40 max-w-xl mx-auto">Tutto Incluso senza sorprese</p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-4">
            {[
              'Demolizione cucina esistente',
              'Rimozione macerie',
              'Impianto elettrico nuovo',
              'Impianto idraulico modificato',
              'Pavimentazione nuova',
              'Rivestimenti pareti',
              'Posa cucina su misura',
              'Montaggio elettrodomestici',
              'Assistenza post-vendita'
            ].map((item, index) => (
              <div key={index} className="bg-[#0a0a0f] rounded-xl p-5 flex items-center gap-3 border border-white/[0.06] hover:border-[#c9a962]/20 transition-all">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { icon: BanknotesIcon, title: "Investimento", desc: "Da 18.000€ a 80.000€" },
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h2 className="text-3xl sm:text-4xl font-light text-white mb-6">Hai bisogno di una nuova cucina?</h2>
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            ...
            Scopriamo insieme la cucina dei tuoi sogni.
          </p>
