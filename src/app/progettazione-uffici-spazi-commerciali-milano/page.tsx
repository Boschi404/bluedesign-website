...
export const metadata = { 
  title: 'Progettazione Uffici e Spazi Commerciali Milano',
  description: 'Progettazione uffici e spazi commerciali a Milano. BlueDesign dal 1990.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Progettazione Uffici e Spazi Commerciali',
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Uffici e spazi commerciali Milano" 
            fill 
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Uffici a <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Progettazione <span className="text-white font-medium">uffici e spazi commerciali</span>. Ambienti di lavoro efficienti.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c9a962]/10 rounded-full mb-6">
              ...
              <span className="text-[#c9a962] text-sm font-medium">Progettazione Professionale</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-4">I tuoi problemi, la nostra soluzione</h2>
            <p className="text-white/50 max-w-2xl mx-auto">Progettiamo spazi di lavoro che migliorano produttività e benessere.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: HomeIcon, title: "Uffici poco produttivi", desc: "Progettiamo spazi che migliorano il benessere e la produttività.", highlight: "Efficiency boost" },
              { icon: StarIcon, title: "Ambienti commerciali", desc: "Allestimenti per negozi, vetrine e locali.", highlight: "Design d'effetto" },
              { icon: SparklesIcon, title: "Spazi open space", desc: "Soluzioni per ambienti di lavoro condivisi.", highlight: "Collaborazione" },
              { icon: HomeIcon, title: "Reception e attesa", desc: "Aree accoglienti per clienti e visitatori.", highlight: "Prima impressione" }
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { icon: ClockIcon, title: "Tempi", desc: "4-12 settimane" },
              { icon: BanknotesIcon, title: "Prezzi", desc: "Da 5.000€" },
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            Progetta il tuo spazio commerciale con i migliori professionisti. Ti offriamo un sopralluogo e un preventivo <span className="text-[#c9a962] font-semibold">gratuito e senza impegno</span>.
          </p>
