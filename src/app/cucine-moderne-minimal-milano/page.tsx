...
export const metadata = { 
  title: 'Cucine Moderne Minimal Milano',
  description: 'Cucine moderne e minimal a Milano. BlueDesign dal 1990.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Cucine Moderne Minimal',
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Cucine moderne minimal Milano" 
            fill 
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Cucine Moderne a <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Design <span className="text-white font-medium">minimal</span> per la tua cucina. Eleganza e funzionalità.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c9a962]/10 rounded-full mb-6">
              ...
              <span className="text-[#c9a962] text-sm font-medium">Design Minimal</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-4">I tuoi problemi, la nostra soluzione</h2>
            <p className="text-white/50 max-w-2xl mx-auto">Progettiamo cucine moderne con linee pulite e design contemporaneo.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: HomeIcon, title: "Cucine minimal", desc: "Linee pulite e design contemporaneo per la tua cucina.", highlight: "Linee essenziali" },
              { icon: StarIcon, title: "Materiali di qualità", desc: "Finiture premium: laminato, vetro, acciaio.", highlight: "Premium finish" },
              { icon: SparklesIcon, title: "Soluzioni salvaspazio", desc: "Ottimizziamo ogni metro quadrato.", highlight: "Spazio ottimizzato" },
              { icon: HomeIcon, title: "Colori neutri", desc: "Bianco, grigio, antracite: eleganza senza tempo.", highlight: "Eleganza classica" }
            ].map((item, index) => (
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            Progetta la tua cucina minimal con i migliori professionisti di Milano. Ti offriamo un sopralluogo e un preventivo <span className="text-[#c9a962] font-semibold">gratuito e senza impegno</span>.
          </p>
