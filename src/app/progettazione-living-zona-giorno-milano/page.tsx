...
export const metadata = { 
  title: 'Progettazione Living e Zona Giorno Milano',
  description: 'Progettazione living e zona giorno a Milano.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Progettazione Living e Zona Giorno',
    ...
    <main className="min-h-screen bg-[#0a0a0f]">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image src="/images/products/bagno.jpg" alt="Living zona giorno Milano" fill className="object-cover" priority />
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/[0.03] backdrop-blur-sm border border-white/[0.08] rounded-full mb-8">
              ...
              <span className="text-white/80 text-xs font-light tracking-[0.15em] uppercase">Arredamento di Design dal 1990</span>
            </div>
            <div className="mb-8">
              <Image src="/images/logo/logo-white.png" alt="BlueDesign" width={400} height={160} className="mx-auto" priority />
            </div>
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">Living e Zona Giorno <span className="font-semibold text-[#c9a962]">Milano</span></h1>
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">Progettazione zona giorno di <span className="text-white font-medium">design</span></p>
            <div className="flex flex-wrap items-center justify-center gap-6 sm:gap-8 mb-10 text-white/40 text-sm uppercase tracking-[0.1em]">
              <span className="flex items-center gap-2"><span className="text-[#c9a962] font-semibold">35+</span> Anni Esperienza</span>
              <span className="hidden sm:inline">•</span>
              <span className="flex items-center gap-2"><span className="text-[#c9a962] font-semibold">500+</span> Progetti</span>

            </div>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="tel:+390239326173" className="btn btn-primary inline-flex text-base px-10 py-4" style={{ boxShadow: "0 20px 40px rgba(201,169,98,0.25)" }}>Chiama ora</Link>
              <Link href="/contatti" className="inline-flex items-center gap-2 text-white/70 hover:text-white text-base px-6 py-4 transition-colors">Consulenza gratuita <ArrowRightIcon className="w-5 h-5" /></Link>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 bg-[#0a0a0f]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-white/50 max-w-2xl mx-auto">Progettiamo living e zone giorno che trasformano radicalmente il tuo spazio. Ogni progetto è unico, come unico sei tu.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { 
                icon: HomeIcon, 
                title: "Vuoi un living moderno e funzionale?", 
                desc: "Cerchi un divano su misura che combini design e comfort? Progettiamo divani modulari con tessuti di alta qualità, realizzati artigianalmente per resistere nel tempo.",
                highlight: "Design e comfort"
              },
              { 
                icon: SparklesIcon, 
                title: "Hai bisogno di soluzioni tv e contenitori?", 
                desc: "Il soggiorno appare disordinato e manca spazio per i tuoi oggetti? Realizziamo mobili TV a parete, librerie e credenze su misura che valorizzano lo spazio.",
                highlight: "Organizzazione perfetta"
              },
              { 
                icon: StarIcon, 
                title: "Vuoi un tavolo design per la zona pranzo?", 
                desc: "Cerchi un tavolo da pranzo elegante e funzionale? Progettiamo tavoli e sedie di design, consolle trasformabili e soluzioni su misura per ogni esigenza.",
                highlight: "Eleganza artigianale"
              },
              { 
                icon: HomeIcon, 
                title: "Hai bisogno di librerie divisorie?", 
                desc: "Desideri dividere lo spazio senza rinunciare alla luce? Creiamo librerie divisorie e wall unit complete che definiscono gli ambienti con stile.",
                highlight: "Spazio e luce"
              }
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { icon: ClockIcon, title: "Tempi di consegna", desc: "10-16 settimane dalla conferma" },
              { icon: BanknotesIcon, title: "Investimento", desc: "Da 8.000€ a 45.000€" },
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h2 className="text-3xl sm:text-4xl font-light text-white mb-6">Trasforma il tuo living</h2>
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            ...
            Scopriamo insieme il living dei tuoi sogni.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
            <Link href="tel:+390239326173" className="btn btn-primary text-lg px-10 py-5">Chiamaci ora</Link>
