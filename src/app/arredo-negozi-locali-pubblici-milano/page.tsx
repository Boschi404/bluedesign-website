...
export const metadata = { 
  title: 'Arredo Negozi e Locali Pubblici Milano',
  description: 'Arredo negozi e locali pubblici a Milano. BlueDesign dal 1990.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Arredo Negozi e Locali Pubblici',
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Arredo negozi locali pubblici Milano" 
            fill 
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Arredo Negozi a <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Allestimenti <span className="text-white font-medium">commerciali</span>professionali. Visibilità e stile.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c9a962]/10 rounded-full mb-6">
              ...
              <span className="text-[#c9a962] text-sm font-medium">Allestimenti Professionali</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-4">I tuoi problemi, la nostra soluzione</h2>
            <p className="text-white/50 max-w-2xl mx-auto">Progettiamo spazi commerciali che attraggono clienti e valorizzano i tuoi prodotti.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: HomeIcon, title: "Negozi poco invitanti", desc: "Allestimenti che attraggono clienti e valorizzano i prodotti.", highlight: "Design d'impatto" },
              { icon: StarIcon, title: "Locali pubblici", desc: "Bar, ristoranti, pub: arredo funzionale e di design.", highlight: "Estetica e funzionalità" },
              { icon: SparklesIcon, title: "Vetrine efficaci", desc: "Progettiamo vetrine che catturano l'attenzione.", highlight: "Massima visibilità" },
              { icon: HomeIcon, title: "Spazi espositivi", desc: "Design per mostre ed eventi commerciali.", highlight: "Flessibilità" }
            ].map((item, index) => (
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            Arreda il tuo negozio con i migliori professionisti di Milano. Ti offriamo un sopralluogo e un preventivo <span className="text-[#c9a962] font-semibold">gratuito e senza impegno</span>.
          </p>
