...
export const metadata = { 
  title: 'Illuminazione Interni Milano | Progettazione Luce',
  description: 'Progettazione illuminazione interni a Milano. BlueDesign dal 1990.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Illuminazione Interni',
...
<Image 
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Illuminazione a <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Progettazione <span className="text-white font-medium">illuminazione</span> professionale. Creiamo atmosfere uniche.
            </p>
      ...
      <section className="py-24 bg-[#0a0a0f]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-white/50 max-w-2xl mx-auto">Progettiamo illuminazione che trasforma radicalmente i tuoi ambienti. Ogni progetto è unico.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: StarIcon, title: "Hai un'illuminazione inadeguata?", desc: "La luce attuale non valorizza i tuoi spazi e non crea l'atmosfera desiderata? Progettiamo soluzioni illuminotecniche professionali che esaltano ogni ambiente.", highlight: "Design illuminotecnico" },
              { icon: HomeIcon, title: "Vuoi trasformare ambienti bui?", desc: "Alcune stanze appaiono buie e poco accoglienti anche di giorno? Realizziamo progetti di illuminazione che trasformano stanze buie in spazi luminosi.", highlight: "Luminosità garantita" },
              { icon: SparklesIcon, title: "Cerchi risparmio energetico?", desc: "Desideri ridurre i consumi senza rinunciare alla qualità della luce? Utilizziamo tecnologie LED a basso consumo per abbattere i costi energetici.", highlight: "LED a risparmio" },
              { icon: HomeIcon, title: "Hai bisogno di luce funzionale?", desc: "Ogni zona della casa richiede un tipo diverso di illuminazione? Progettiamo soluzioni specifiche per cucina, bagno, studio e living.", highlight: "Zone personalizzate" }
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { icon: ClockIcon, title: "Tempi di consegna", desc: "4-8 settimane dalla conferma" },
              { icon: BanknotesIcon, title: "Investimento", desc: "Da 2.000€ a 15.000€" },
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h2 className="text-3xl sm:text-4xl font-light text-white mb-6">Hai bisogno di illuminazione?</h2>
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            ...
            Scopriamo insieme l'illuminazione perfetta per i tuoi spazi.
          </p>
