...
export const metadata = { 
  title: 'Fornitura Mobili Arredi su Misura Milano',
  description: 'Fornitura mobili e arredi su misura a Milano. BlueDesign dal 1990.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Fornitura Mobili Arredi su Misura',
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Arredi su Misura <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Fornitura <span className="text-white font-medium">mobili</span> di design. Su misura per te.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c9a962]/10 rounded-full mb-6">
              ...
              <span className="text-[#c9a962] text-sm font-medium">Arredamento su Misura</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-4">I tuoi problemi, la nostra soluzione</h2>
            <p className="text-white/50 max-w-2xl mx-auto">Forniamo mobili di design su misura per valorizzare ogni ambiente.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: HomeIcon, title: "Mobili su misura", desc: "Armadi, librerie, mobili bagno: tutto in cm.", highlight: "100% personalizzato" },
              { icon: StarIcon, title: "Marchi top", desc: "Olivieri, Fimar, Varenna: i migliori brand.", highlight: "Qualità garantita" },
              { icon: SparklesIcon, title: "Consegna garantita", desc: "Tempi certi e montaggio professionale.", highlight: "Puntualità" },
              { icon: HomeIcon, title: "Consulenza gratuita", desc: "Ti aiutiamo a scegliere l'arredo perfetto.", highlight: "Supporto completo" }
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { icon: ClockIcon, title: "Tempi", desc: "2-6 settimane" },
              { icon: BanknotesIcon, title: "Prezzi", desc: "Da 1.000€" },
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            Trova l'arredo perfetto con i migliori professionisti. Ti offriamo un sopralluogo e un preventivo <span className="text-[#c9a962] font-semibold">gratuito e senza impegno</span>.
          </p>
