...
export const metadata = { 
  title: 'Ristrutturazione Veloce Senza Polvere Milano',
  description: 'Ristrutturazione rapida senza polvere a Milano. BlueDesign dal 1990.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Ristrutturazione Senza Polvere',
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Ristrutturazione veloce senza polvere Milano" 
            fill 
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Ristrutturazione Veloce <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Senza <span className="text-white font-medium">polvere</span>. Lavori rapidi e puliti.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c9a962]/10 rounded-full mb-6">
              ...
              <span className="text-[#c9a962] text-sm font-medium">Lavori Veloce e Puliti</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-4">I tuoi problemi, la nostra soluzione</h2>
            <p className="text-white/50 max-w-2xl mx-auto">Ristrutturazioni rapide e senza polvere per non disturbare la tua routine.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: StarIcon, title: "Tempi rapidi", desc: "Ristrutturazioni in 7-15 giorni.", highlight: "7-15 giorni" },
              { icon: HomeIcon, title: "Lavori puliti", desc: "Tecniche senza polvere per ambiente pulito.", highlight: "Senza polvere" },
              { icon: SparklesIcon, title: "Durante l'inverno", desc: "Lavoriamo anche nei mesi freddi.", highlight: "Tutto l'anno" },
              { icon: HomeIcon, title: "H24", desc: "Interventi anche in orari notturni.", highlight: "Flessibilità totale" }
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { icon: ClockIcon, title: "Tempi", desc: "7-15 giorni" },
              { icon: BanknotesIcon, title: "Prezzi", desc: "Da 2.000€" },
              { icon: PhoneIcon, title: "Orari", desc: "Lunedì-Sabato 9:00-19:30" }
            ].map((item, index) => (
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            Ristruttura in fretta e senza stress con i migliori professionisti. Ti offriamo un sopralluogo e un preventivo <span className="text-[#c9a962] font-semibold">gratuito e senza impegno</span>.
          </p>
          ...
          <div className="flex items-center justify-center gap-6 text-white/40 text-sm">
            ...
            <div className="flex items-center gap-2"><CheckCircleIcon className="w-4 h-4 text-green-500" /><span>Garanzia 2 anni</span></div>
          </div>
