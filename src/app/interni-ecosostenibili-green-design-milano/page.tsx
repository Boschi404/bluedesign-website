...
export const metadata = { 
  title: 'Interni Ecosostenibili Green Design Milano',
  description: 'Interni ecosostenibili e green design a Milano. BlueDesign dal 1990.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Interni Ecosostenibili Green Design',
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Green Design <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Interni <span className="text-white font-medium">ecosostenibili</span>. Design rispettoso dell'ambiente.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c9a962]/10 rounded-full mb-6">
              ...
              <span className="text-[#c9a962] text-sm font-medium">Design Sostenibile</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-4">I tuoi problemi, la nostra soluzione</h2>
            <p className="text-white/50 max-w-2xl mx-auto">Creiamo interni ecosostenibili che rispettano l'ambiente e il tuo benessere.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: StarIcon, title: "Materiali eco", desc: "Legno certificato, vernici atossiche.", highlight: "Certificazioni verdi" },
              { icon: HomeIcon, title: "Risparmio energetico", desc: "Isolamento e impianti efficienti.", highlight: "Efficiency energetica" },
              { icon: SparklesIcon, title: "Riciclo", desc: "Arredo da materiali riciclati.", highlight: "Economia circolare" },
              { icon: HomeIcon, title: "Benessere abitativo", desc: "Qualità dell'aria e comfort.", highlight: "Salute garantita" }
            ].map((item, index) => (
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            Design ecosostenibile con i migliori professionisti. Ti offriamo un sopralluogo e un preventivo <span className="text-[#c9a962] font-semibold">gratuito e senza impegno</span>.
          </p>
