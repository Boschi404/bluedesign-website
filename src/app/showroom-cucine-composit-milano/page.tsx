...
export const metadata = { 
  title: 'Showroom Cucine Composit Milano',
  description: 'Showroom cucine Composit a Milano. BlueDesign dal 1990.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Showroom Cucine Composit',
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Showroom cucine Composit Milano" 
            fill 
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Showroom Composit <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Vieni a trovarci in <span className="text-white font-medium">showroom</span>. Scopri le cucine Composit.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-[#c9a962]/10 rounded-full mb-6">
              ...
              <span className="text-[#c9a962] text-sm font-medium">Showroom Espositivo</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-light text-white mb-4">I tuoi problemi, la nostra soluzione</h2>
            <p className="text-white/50 max-w-2xl mx-auto">Vieni a scoprire le cucine Composit nel nostro showroom di Milano.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: HomeIcon, title: "Cucine su misura", desc: "Progettiamo cucine Composit personalizzate.", highlight: "Design italiano" },
              { icon: StarIcon, title: "Showroom espositivo", desc: "Vieni a vedere le soluzioni in mostra.", highlight: "Visibile dal vivo" },
              { icon: SparklesIcon, title: "Consulenza professionale", desc: "Ti guidiamo nella scelta del modello perfetto.", highlight: "Esperienza garantita" },
              { icon: HomeIcon, title: "Consegna chiavi in mano", desc: "Installazione completa e garantita.", highlight: "Installazione professionale" }
            ].map((item, index) => (
      ...
      <section className="py-24 bg-[#12121a]">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              { icon: MapPinIcon, title: "Showroom", desc: "Milano, Piazzale Lugano" },
              { icon: ClockIcon, title: "Tempi", desc: "8-14 settimane" },
              { icon: BanknotesIcon, title: "Prezzi", desc: "Da 8.000€" },
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            Vieni a trovarci in showroom per vedere le cucine Composit. Ti offriamo un sopralluogo e un preventivo <span className="text-[#c9a962] font-semibold">gratuito e senza impegno</span>.
          </p>
