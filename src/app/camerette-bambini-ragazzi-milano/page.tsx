...
export const metadata = { 
  title: 'Camerette Bambini e Ragazzi Milano | Progettazione + Arredo',
  description: 'Camerette per bambini e ragazzi a Milano. BlueDesign dal 1990.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Camerette Bambini e Ragazzi',
    ...
    <main className="min-h-screen bg-[#0a0a0f]">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Camerette bambini e ragazzi Milano" 
            fill 
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Camerette a <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Progettazione camere per <span className="text-white font-medium">bambini e ragazzi</span>. Soluzioni funzionali e di design.
            </p>
      ...
      <section className="py-24 bg-[#0a0a0f]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-white/50 max-w-2xl mx-auto">Progettiamo camerette che trasformano radicalmente lo spazio dei tuoi figli. Ogni progetto è unico.</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { icon: HomeIcon, title: "Hai una cameretta troppo piccola?", desc: "Lo spazio è limitato e non sai come renderlo funzionale? Progettiamo soluzioni salvaspazio che sfruttano ogni centimetro, creando ambienti ordinati e accoglienti.", highlight: "Spazio ottimizzato" },
              { icon: StarIcon, title: "Vuoi uno spazio multifunzionale?", desc: "Desideri che la camera ospiti letto, studio e zona gioco? Realizziamo ambienti modulari che si adattano alle esigenze che cambiano crescendo.", highlight: "Cresce con loro" },
              { icon: SparklesIcon, title: "Cerchi uno stile adatto all'età?", desc: "Hai bisogno di una soluzione che cresca con tuo figlio? Progettiamo dalla cameretta per bimbo alla stanza teenager con stili e funzionalità evoluti.", highlight: "Design evolutivo" },
              { icon: HomeIcon, title: "Vuoi più spazio per i giocattoli?", desc: "La camera è disordinata e manca spazio per riporre giocattoli e vestiti? Creiamo armadi e contenitori su misura che tengono tutto in ordine.", highlight: "Ordine garantito" }
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { icon: BanknotesIcon, title: "Investimento", desc: "Da 5.000€ a 25.000€" },
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h2 className="text-3xl sm:text-4xl font-light text-white mb-6">Hai bisogno di una cameretta?</h2>
          <p className="text-white/50 mb-8 max-w-2xl mx-auto leading-relaxed">
            ...
            Scopriamo insieme la cameretta dei sogni dei tuoi figli.
          </p>
