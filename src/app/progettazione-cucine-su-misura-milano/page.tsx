...
export const metadata = { 
  title: 'Cucine su Misura Milano | Progettazione + Rendering 3D',
  description: 'Cerchi un progettista di cucine su misura a Milano? BlueDesign dal 1990.'
};

const jsonLd = {
  '@context': 'https://schema.org',
  '@type': 'Service',
  name: 'Progettazione Cucine su Misura',
    ...
    <main className="min-h-screen bg-[#0a0a0f]">
        ...
        <div className="relative z-10 container mx-auto px-4 pt-24">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl md:text-7xl font-light text-white mb-6">
              Cucine su Misura a <span className="font-semibold text-[#c9a962]">Milano</span>
            </h1>
            
            <p className="text-white/60 text-lg sm:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
              Progettazione professionale con <span className="text-white font-medium">rendering 3D</span>. Dal concept alla consegna chiavi in mano.
            </p>
      ...
      <section className="py-24 bg-[#0a0a0f]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-white/50 max-w-2xl mx-auto">Progettiamo cucine che cambiano radicalmente il tuo modo di vivere la casa. Ogni progetto e unico, come unico sei tu.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {[
              { 
                icon: HomeIcon, 
                title: "Hai una cucina troppo piccola?", 
                desc: "Sfruttiamo ogni centimetro disponibile con soluzioni salvaspazio intelligenti. Pensili ad altezza soffitto, colonne estraibili, organizer interni che maximizzano lo spazio senza rinunciare al design.",
                highlight: "Ottimizzazione spazio"
              },
              { 
                icon: SparklesIcon, 
                title: "La tua cucina non funziona?", 
                desc: "Il triangolo lavoro e inefficiente, manca piano d'appoggio. Ridisegniamo il layout da zero per massimizzare ergonomia e funzionalita. Ogni movimento sara naturale.",
                highlight: "Ergonomia garantita"
              },
              { 
                icon: StarIcon, 
                title: "Cucina datata da rinnovare?", 
                desc: "Se la tua cucina ha 15-20 anni ma la struttura e sana, possiamo rifarla completamente cambiando ante, top e maniglie. Risparmio significativo rispetto a una nuova.",
                highlight: "Risparmio fino al 40%"
              },
              { 
                icon: HomeIcon, 
                title: "Vuoi una cucina open space?", 
                desc: "Creiamo un ambiente unico integrando cucina e living in uno spazio armonioso e funzionale. Il cuore della tua casa diventera il punto di incontro per tutta la famiglia.",
                highlight: "Design aperto"
              }
            ].map((item, index) => (
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { icon: ClockIcon, title: "Tempi di consegna", desc: "10-16 settimane dalla conferma del progetto" },
              { icon: BanknotesIcon, title: "Investimento", desc: "Cucine da 12.000€ a 45.000€" },
      ...
      <section className="py-24 bg-gradient-to-b from-[#0a0a0f] to-[#1a1a1a] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <h2 className="text-3xl sm:text-4xl font-light text-white mb-6">Hai bisogno di una cucina su misura?</h2>
